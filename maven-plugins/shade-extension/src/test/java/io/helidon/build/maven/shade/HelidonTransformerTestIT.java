...
public class HelidonTransformerTestIT {
    ...
    private static String archive1UrlPrefix(String basedir) {
        return "jar:file:"
                + basedir
                + "/archive-1/target/helidon-build-tools-shade-extension-tests-archive-1-"
                + VERSION
                + ".jar!";
    }
    ...
    private static String archive2UrlPrefix(String basedir) {
        return "jar:file:"
                + basedir
                + "/archive-2/target/helidon-build-tools-shade-extension-tests-archive-2-"
                + VERSION
                + ".jar!";
    }
    ...
    private static String bundleUrlPrefix(String basedir) {
        return "jar:file:"
                + basedir
                + "/bundle/target/helidon-build-tools-shade-extension-tests-bundle-"
                + VERSION
                + ".jar!";
    }

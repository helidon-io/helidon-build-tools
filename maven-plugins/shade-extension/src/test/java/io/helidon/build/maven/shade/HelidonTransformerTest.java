...
import static io.helidon.build.maven.shade.HelidonTransformer.CONFIG_METADATA_PATH;
import static io.helidon.build.maven.shade.HelidonTransformer.FEATURE_METADATA_PATH;
import static io.helidon.build.maven.shade.HelidonTransformer.SERVICE_REGISTRY_PATH;
...
class HelidonTransformerTest {
    ...
    void testAll() throws IOException {
        ...
        HelidonTransformer transformer = new HelidonTransformer();

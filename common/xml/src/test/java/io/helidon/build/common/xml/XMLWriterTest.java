...
class XMLWriterTest {
    ...
    void testEmptyElement() {
        ...
        writer.startElement("foo").endElement();
    ...
    void testProlog() {
        StringWriter buf = new StringWriter();
        XMLWriter writer = new XMLWriter(buf);
        writer.prolog().startElement("foo").endElement();
    ...
    void testEmptyElementWithAttributes() {
        StringWriter buf = new StringWriter();
        XMLWriter writer = new XMLWriter(buf);
        writer.startElement("foo").attribute("bar", "true").endElement();
    ...
    void testElementWithValue() {
        StringWriter buf = new StringWriter();
        XMLWriter writer = new XMLWriter(buf);
        writer.startElement("foo").value("bar").endElement();
    ...
    void testElementWithEmptyChild() {
        StringWriter buf = new StringWriter();
        XMLWriter writer = new XMLWriter(buf);
        writer.startElement("foo").startElement("bar").endElement().endElement();
        assertThat(buf.toString(), is("<foo>\n    <bar/>\n</foo>"));
    }
    ...
    void testElementWithChildren() {
        StringWriter buf = new StringWriter();
        XMLWriter writer = new XMLWriter(buf);
        writer.startElement("foo").startElement("bar").value("true").endElement().endElement();
        assertThat(buf.toString(), is("<foo>\n    <bar>true</bar>\n</foo>"));
    }
    ...
    void testElementWithTextAndChild() {
        StringWriter buf = new StringWriter();
        XMLWriter writer = new XMLWriter(buf);
        writer.append(XMLElement.builder()
                .name("a").value("b")

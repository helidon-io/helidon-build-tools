...
/**
 * Copied from {@code org.apache.maven.artifact.versioning.ComparableVersion}.
 */
class ComparableVersion implements Comparable<ComparableVersion> {
     ...
     * This class is used both for the global item list and for sub-lists (which start with '-(number)' in the

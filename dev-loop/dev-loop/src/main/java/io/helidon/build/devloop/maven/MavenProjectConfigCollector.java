...
import io.helidon.build.cli.common.CliProperties;
...
public class MavenProjectConfigCollector extends AbstractMavenLifecycleParticipant {
    ...
    private static final boolean ENABLED = "true".equals(System.getProperty(CliProperties.HELIDON_CLI_PROPERTY));

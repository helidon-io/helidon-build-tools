...
public class LinkReferenceDefinitionParser {
    ...
    public void parse(SourceLine line) {
        ...
        if (state == LinkReferenceDefinitionParser.State.PARAGRAPH) {
        ...
        while (scanner.hasNext()) {
            ...
            if (!success) {
                state = LinkReferenceDefinitionParser.State.PARAGRAPH;
                return;
            }
        }
    }
    ...
    private boolean startDefinition(Scanner scanner) {
        ...
        state = LinkReferenceDefinitionParser.State.LABEL;
    ...
    private boolean label(Scanner scanner) {
        ...
        if (!scanner.hasNext()) {
            ...
            state = LinkReferenceDefinitionParser.State.DESTINATION;
    ...
    private boolean destination(Scanner scanner) {
        ...
        state = LinkReferenceDefinitionParser.State.START_TITLE;
        return true;
    }
    ...
    private boolean startTitle(Scanner scanner) {
        scanner.whitespace();
        if (!scanner.hasNext()) {
            state = LinkReferenceDefinitionParser.State.START_DEFINITION;
            return true;
        }
        ...
        if (titleDelimiter != '\0') {
            state = LinkReferenceDefinitionParser.State.TITLE;
